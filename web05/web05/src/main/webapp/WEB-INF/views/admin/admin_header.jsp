...
<header id="header" class="header">
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
	    <div class="container px-4 px-lg-5">
	        <a class="navbar-brand" href="<%=path_hd %>/">SOOM SHOP</a>
	        ...
	        <div class="collapse navbar-collapse" id="navbarSupportedContent">
	            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
	                ...
	                <li class="nav-item dropdown">
	                    ...
	                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
	                        <li><a class="dropdown-item" href="<%=path_hd %>/admin/ProductList">상품목록</a></li>
	                        <li><a class="dropdown-item" href="#!">상품카테고리 등록</a></li>
	                        <li><a class="dropdown-item" href="#!">상품등록</a></li>
	                         <li><a class="dropdown-item" href="#!">상품 정보 수정</a></li>
	                        <li><hr class="dropdown-divider"></li>
	                ...
	                <li class="nav-item dropdown">
	                    ...
	                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
	                        <li><a class="dropdown-item" href="<%=path_hd %>/admin/NoticeList">공지 사항 관리</a></li>
                   	        <li><a class="dropdown-item" href="<%=path_hd %>/admin/ReviewList">리뷰 관리</a></li>
	                        <li><a class="dropdown-item" href="<%=path_hd %>/admin/QNAList">질문 및 답변 관리</a></li>	
	                     </ul>
	                </li>
	                <li class="nav-item dropdown">
